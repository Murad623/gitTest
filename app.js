...
app.get('/', function (req, res) {
    res.send(`Name : ${JSON.parse(value)[0].name} | ID : ${JSON.parse(value)[0].id} | Age : ${JSON.parse(value)[0].age} <br>
    Name : ${JSON.parse(value)[1].name} | ID : ${JSON.parse(value)[1].id} | Age : ${JSON.parse(value)[1].age} <br>
